...
@Stateless
@LocalBean
public class AssetsCompareFacade extends AbstractFacade<AssetsCompare> {

    @PersistenceContext(unitName = "findkme")
    private EntityManager em;

    public AssetsCompareFacade() {
        super(AssetsCompare.class);
    }
    ...
    public List<AssetsCompare> findAllAssetsThatExistInAssetsCompare() {
        List<AssetsCompare> l = new ArrayList();
    ...
    public List<AssetsCompare> findAllAssetsThatNotExistInAssetsCompare() {
        List<AssetsCompare> l = new ArrayList();
